...
{
    public partial class FormDesktopC : Form
    {
        ...
        public FormDesktopC()
        {
            ...
            DgvRefresh();
            imageColumnCreate();
            dataGridViewDC.Columns[0].HeaderText = "Model";
            dataGridViewDC.Columns[1].HeaderText = "OS";
            dataGridViewDC.Columns[2].HeaderText = "Machine Name";
            dataGridViewDC.Columns[3].HeaderText = "Serial No";
            dataGridViewDC.Columns[4].HeaderText = "HDD";
            dataGridViewDC.Columns[5].HeaderText = "Memory";
            dataGridViewDC.Columns[6].HeaderText = "Location";
            dataGridViewDC.Columns[7].HeaderText = "Connected";
            dataGridViewDC.Columns[8].HeaderText = "Details";
            dataGridViewDC.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;
        }

        private void FormDesktopC_Load(object sender, EventArgs e)
        {
        }
        ...
        private void DgvRefresh()
        {
            ...
            String commandText = "SELECT  Model, OS, MachineName,SerialNo,HDD,ComputerMemory,Department,IsConnected " +
                                 ...
                                 "WHERE IsConnected = TRUE and ComputerType = 'D'";
            using (MySqlConnection connection = new MySqlConnection(connectionString))
            {
                ...
                dataGridViewDC.DataSource = dtRecordDB;
                connection.Close();
            ...
            dataGridViewDC.Columns[0].SortMode = DataGridViewColumnSortMode.NotSortable;
            dataGridViewDC.Columns[1].SortMode = DataGridViewColumnSortMode.NotSortable;
            dataGridViewDC.Columns[2].SortMode = DataGridViewColumnSortMode.NotSortable;
            dataGridViewDC.Columns[3].SortMode = DataGridViewColumnSortMode.NotSortable;
            dataGridViewDC.Columns[4].SortMode = DataGridViewColumnSortMode.NotSortable;
            dataGridViewDC.Columns[5].SortMode = DataGridViewColumnSortMode.NotSortable;
            dataGridViewDC.Columns[6].SortMode = DataGridViewColumnSortMode.NotSortable;
            dataGridViewDC.Columns[7].SortMode = DataGridViewColumnSortMode.NotSortable;
            //Count label
            countLabelDC.Text = "Ağa bağlı Desktoplar : " + dataGridViewDC.Rows.Count.ToString();
        }

        private void DgvUpdate()
        {
            for (int i = 0; i < dataGridViewDC.Rows.Count; i++)
            {
                ...
                using (MySqlConnection connection = new MySqlConnection(connectionString))
                {
                    ...
                    command.Parameters.Add("@v0", MySqlDbType.VarChar, 50).Value = dataGridViewDC.Rows[i].Cells[4].Value;
                    command.Parameters.Add("@v1", MySqlDbType.VarChar, 50).Value = dataGridViewDC.Rows[i].Cells[1].Value;
                    command.Parameters.Add("@v2", MySqlDbType.VarChar, 50).Value = dataGridViewDC.Rows[i].Cells[2].Value;
                    command.Parameters.Add("@v3", MySqlDbType.VarChar, 50).Value = dataGridViewDC.Rows[i].Cells[3].Value;
                    command.Parameters.Add("@v4", MySqlDbType.Int16, 50).Value = dataGridViewDC.Rows[i].Cells[5].Value;
                    command.Parameters.Add("@v5", MySqlDbType.Int16, 50).Value = dataGridViewDC.Rows[i].Cells[6].Value;
                    command.Parameters.Add("@v6", MySqlDbType.VarChar, 50).Value = dataGridViewDC.Rows[i].Cells[7].Value;
                    command.Parameters.Add("@v7", MySqlDbType.Int16).Value = dataGridViewDC.Rows[i].Cells[8].Value;
        ...
        {
            DataGridViewRow row = this.dataGridViewDC.SelectedRows[0];
        ...
        private void DgvInsert()
        {
            String commandInsertText = "INSERT INTO computer " +
                                       ...
                                       "values (@I1 , @I2 , @I3 , 'D' , @I4 , @I5 , @I6 , True )";
        ...
        private void imageColumnCreate()
        {
            ...
            dataGridViewDC.Columns.Add(detailImage);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            var commandText = "SELECT Model, OS, MachineName,SerialNo,HDD,ComputerMemory,Department,IsConnected " +
                              ...
                              "IsConnected = True and ComputerType = 'D' ";

            using (MySqlConnection connection = new MySqlConnection(connectionString))
            {
                MySqlCommand command = new MySqlCommand(commandText, connection);

                command.Parameters.Add("@N", MySqlDbType.VarChar, 50).Value = textBoxSerial.Text;
                command.Parameters.Add("@N2", MySqlDbType.VarChar, 50).Value = textBoxMachine.Text;
                command.Parameters.Add("@N3", MySqlDbType.VarChar, 50).Value = textBoxModel.Text;
                connection.Open();
                ...
                dataGridViewDC.DataSource = dtRecordFiltered;
        ...
        private void buttonUpdate_Click(object sender, EventArgs e)
        {
            ...
            countLabelDC.Visible = false;
            buttonPrint.Visible = false;
            dataGridViewDC.ReadOnly = false;
            this.dataGridViewDC.Columns["SerialNo"].ReadOnly = true;
        }
        ...
        private void buttonPrint_Click(object sender, EventArgs e)
        {
            ...
            Printer.PrintDataGridView(dataGridViewDC);
        }
        ...
        private void dataGridViewDC_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.ColumnIndex == 0)
            {
                DataGridViewCell cell = dataGridViewDC.SelectedCells[0];
                string columnSerialNo = dataGridViewDC.Rows[cell.RowIndex].Cells[4].Value.ToString();
